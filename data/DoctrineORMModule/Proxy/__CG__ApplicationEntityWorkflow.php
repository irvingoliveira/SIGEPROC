 ...
 */
class Workflow extends \Application\Entity\Workflow implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idWorkflow', 'descricao', 'assunto', 'fluxosPostos');
        }
    ...
    public function getIdWorkflow()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdWorkflow();
        }
     ...
     * {@inheritDoc}
     */
    public function setAssunto(\Application\Entity\Assunto $assunto)
    {
