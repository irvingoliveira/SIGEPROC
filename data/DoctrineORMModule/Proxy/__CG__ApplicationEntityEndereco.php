...
class Endereco extends \Application\Entity\Endereco implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idEndereco', 'logradouro', 'numero', 'complemento', 'bairro', 'cidade', 'orgaoExterno');
        }
    ...
    public function getOrgaoExterno()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrgaoExterno', array());

        return parent::getOrgaoExterno();
    }
     ...
     * {@inheritDoc}
     */
    public function setOrgaoExterno(\Application\Entity\OrgaoExterno $orgaoExterno)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrgaoExterno', array($orgaoExterno));

        return parent::setOrgaoExterno($orgaoExterno);
    }
